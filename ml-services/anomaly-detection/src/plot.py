...
model = joblib.load(models_dir / "isolation_forest_model.joblib")
...
plt.tight_layout()
plt.savefig(output_dir / "anomalies_comparison.png", dpi=300)
plt.close()

print("Plot generated: output/anomalies_comparison.png")
